...
public interface ExportBigData {
	 ...
	 *            查询参数
	 */
	public void exportToZip(final OutputStream os, final int maxRow, final String sql,
	...
	public void exportToZip(final String[] titles, final OutputStream os, final int maxRow,
